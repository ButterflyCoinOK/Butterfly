...
/* Initialize Butterfly-specific components after chainstate initialization */
void ButterflyTestSetup(NodeContext& node);
void ButterflyTestSetupClose(NodeContext& node);
