...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire lobutterfly.
    var _ = context && context._ || require('lobutterfly') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of lobutterfly methods to
     * make working with arrays, collections, and objects easier. The lobutterfly
     * methods are:
     * [`each/forEach`](https://lobutterfly.com/docs#forEach), [`forOwn`](https://lobutterfly.com/docs#forOwn),
     * [`has`](https://lobutterfly.com/docs#has), [`indexOf`](https://lobutterfly.com/docs#indexOf),
     * [`map`](https://lobutterfly.com/docs#map), and [`reduce`](https://lobutterfly.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped lobutterfly methods to
     * make working with Suites easier. The wrapped lobutterfly methods are:
     * [`each/forEach`](https://lobutterfly.com/docs#forEach), [`indexOf`](https://lobutterfly.com/docs#indexOf),
     * [`map`](https://lobutterfly.com/docs#map), and [`reduce`](https://lobutterfly.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add lobutterfly methods to Benchmark.
    ...
    // Add lobutterfly methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['lobutterfly', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
