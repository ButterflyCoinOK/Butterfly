...
//! Interface for the src/evo part of a butterfly node (butterflyd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a butterfly node (butterflyd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a butterfly node (butterflyd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a butterfly node (butterflyd process).
...
//! Top-level interface for a butterfly node (butterflyd process).
class Node
{
public:
    virtual ~Node() {}
