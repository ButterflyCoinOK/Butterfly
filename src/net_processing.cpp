 ...
 *  We have 4 times smaller block times in Butterfly, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Butterfly Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // BTFC this code also handles non-TXs (Butterfly specific messages)
