...
/** Utility functions used by the Butterfly Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "butterfly:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load butterfly specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a butterfly specific theme is activated (light/dark).*/
