 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1717189881, nBits=1e0ffff0, nNonce=2618224, vtx=1)
...
{
    const char* pszTimestamp = "nytimes052024 Volcano erupts in Iceland 800 evacuated with BTFC change";
    const CScript genesisOutputScript = CScript() << ParseHex("0449530d8dad4b59cf246ec0583fc9b73228cbeaca45d8aa0adb75168b669765815a31f1d6358748b4a0befda06853e97e89e69f707c29a5fd93dde201cd5f3b49") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 1 + 120; // V19 activation height + miner confirmation window
        ...
        consensus.defaultAssumeValid = uint256S("0x00000d449859f4797c18f852cb579a5ac8259a6e88344d7ffce18111f238f23a"); 
        ...
        // Butterfly BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Butterfly BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Butterfly BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"3FQkoSh4X3pS8dXX2HoAYev6C3uzRAQGN1"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000005b05ea6868ab2a9ab5518298f7085b34e2524835ebefa88793a0451e788"); 
        ...
        genesis = CreateGenesisBlock(1717189886UL, 5001294UL, 0x1e0ffff0, 1, 12 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000005b05ea6868ab2a9ab5518298f7085b34e2524835ebefa88793a0451e788"));
        assert(genesis.hashMerkleRoot == uint256S("0x9a03a941eb70bc1d12eeba45b7f4e2e6af658e0e9999c0855b0e2f999c74f435"));
        ...
        // Testnet Butterfly BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Butterfly BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Butterfly BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TH5zmK1yTHqzMnFbKYgTLs981ajLHc3g23"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x000005b05ea6868ab2a9ab5518298f7085b34e2524835ebefa88793a0451e788")},
            }
        };
        ...
        // getchaintxstats 17280 000005b05ea6868ab2a9ab5518298f7085b34e2524835ebefa88793a0451e788
        chainTxData = ChainTxData{
                1717189886, // * UNIX timestamp of last known number of transactions
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1717189891, 0, 0x207fffff, 1, 12 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x6a81a69486d1b15c92ea77bb78578a96fa7640b8116d1893be327de5f8332179"));
        assert(genesis.hashMerkleRoot == uint256S("0x9a03a941eb70bc1d12eeba45b7f4e2e6af658e0e9999c0855b0e2f999c74f435"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 12 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x6a81a69486d1b15c92ea77bb78578a96fa7640b8116d1893be327de5f8332179")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 7VoJh6vGx32Q6bZtwHMku7C4ijCshtzKBo7oJsMe6pYmAdy7SB6
        vSporkAddresses = {"TFrciqZRg72oFQnjGPDmYuH8QmQYxyPy1R"};
        nMinSporkKeys = 1;
        ...
        // Regtest Butterfly addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest Butterfly script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest Butterfly BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Butterfly BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Butterfly BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
