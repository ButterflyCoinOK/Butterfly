                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                    {
                        ...
                        {RPCResult::Type::ARR, "addresses", "array of butterfly addresses",
...
static UniValue getblockstats(const JSONRPCRequest& request)
{
    RPCHelpMan{"getblockstats",
                "\nCompute per block statistics for a given window. All amounts are in BTF.\n"
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::ARR_FIXED, "feerate_percentiles", "Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in BTF per byte)",
                {
    ...
    ret_all.pushKV("subsidy", GetBlockSubsidy(pindex, Params().GetConsensus(), pindex->nHeight));
