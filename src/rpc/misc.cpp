...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"butterfly\" activates all Butterfly-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "butterfly")
    + HelpExampleRpc("debug", "butterfly+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The butterfly address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The butterfly address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of BTF"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of BTF of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in BTF"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in BTF"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in BTF"},
                    {RPCResult::Type::NUM, "received", "The total number of BTF received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "butterfly-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Butterfly features */
    { "butterfly",               "mnsync",                 &mnsync,                 {} },
    { "butterfly",               "spork",                  &spork,                  {"command"} },
    { "butterfly",               "sporkupdate",            &sporkupdate,            {"name","value"} },
