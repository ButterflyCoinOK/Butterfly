...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 BTFC irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on butterflycentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* Butterfly features */
    { "butterfly",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "butterfly",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "butterfly",               "gobject",                &gobject,                {} },
    { "butterfly",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
