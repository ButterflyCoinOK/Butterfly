...
"""Verify that starting butterflyd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start butterflyd with -h for help text")
        ...
        self.log.info("Start butterflyd with -version for version information")
        ...
        self.log.info("Start butterflydd with -fakearg to make sure it does not start")
