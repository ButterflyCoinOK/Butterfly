...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: Butterfly's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'Butterfly', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
