...
"""Test the butterfly specific ZMQ notification interfaces."""
...
from test_framework.test_framework import ButterflyTestFramework
...
class ButterflyZMQTest (ButterflyTestFramework):
    def set_test_params(self):
        ...
        self.set_butterfly_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_butterfly_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that butterflyd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all butterfly related ZMQ publisher
