...
This document provides guidelines for internationalization of the Butterfly Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `butterfly_en.ts` remains unchanged.
