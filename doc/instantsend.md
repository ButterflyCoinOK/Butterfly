...
This mechanism has been integrated into Bitcore-Node-Butterfly which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/butterflypay/insight-api-butterfly#web-socket-api](https://github.com/butterflypay/insight-api-butterfly#web-socket-api)
* API: [https://github.com/butterflypay/insight-api-butterfly#instantsend-transactions](https://github.com/butterflypay/insight-api-butterfly#instantsend-transactions)
