# Support for Output Descriptors in Butterfly Core

Since Butterfly Core v0.17, there is support for Output Descriptors. This is a
...
existing Butterfly Core wallets, a convenience function `combo` is
...
All RPCs in Butterfly Core will include the checksum in their output. Only
