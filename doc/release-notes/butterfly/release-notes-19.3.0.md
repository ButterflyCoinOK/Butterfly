# Butterfly Core version v19.3.0
...
- `wipetxes`: New command for `butterfly-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/ButterflyCoinOK/Butterfly/compare/v19.2.0...butterflypay:v19.3.0).
