Butterfly Core version 0.17.0.2
==========================
...
provided in [DIP-0020](https://github.com/butterflypay/dips/blob/master/dip-0020.md).
...
from other quorum members. This allows Butterfly Platform to obtain required
...
provided in [DIP-0021](https://github.com/butterflypay/dips/blob/master/dip-0021.md).

Platform support
----------------
Support for Butterfly Platform has been expanded through the addition of a new
...
BLS update
----------
Butterfly Core’s BLS signature library has been updated based on v1.0 of the
Chia BLS library to support migration to a new BLS signature scheme which will
be implemented in a future version of Butterfly. These changes will be made to
align with standards and improve security.

Network performance improvements
--------------------------------
This version of Butterfly Core includes multiple optimizations to the network and
p2p message handling code.

We reintroduced [Intra-Quorum Connections](https://github.com/butterflypay/dips/blob/master/dip-0006.md#intra-quorum-communication)
...
reliability. Activation of `SPORK_22_PS_MORE_PARTICIPANTS` in Butterfly v0.16
...
Statoshi backport
------------------
This version includes a [backport](https://github.com/ButterflyCoinOK/Butterfly/pull/2515)
...
RPC changes
-----------
There are seven new RPC commands which are Butterfly specific and seven new RPC
...
will be removed in Butterfly v0.18. Note that the deprecation of wallet accounts
...
Butterfly users. Bitcoin changes that do not align with Butterfly’s product needs, such
...
See detailed [set of changes](https://github.com/ButterflyCoinOK/Butterfly/compare/v0.16.1.1...butterflypay:v0.17.0.2).
