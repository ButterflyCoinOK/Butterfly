# Bootstrappable Butterfly Core Builds

This directory contains the files necessary to perform bootstrappable Butterfly
Core builds.
...
To build Butterfly Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Butterfly Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/butterfly-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/butterflypay/guix.sigs).
...
[guix-docker]: https://github.com/ButterflyCoinOK/Butterfly/tree/master/contrib/guix/Dockerfile
