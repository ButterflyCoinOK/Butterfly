...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The Butterfly Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a Butterfly Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Butterfly Core developers'
...
Arguments:
    <base_directory> - The base directory of Butterfly Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Butterfly Core repository.
"""
